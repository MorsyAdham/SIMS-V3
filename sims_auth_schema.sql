...
-- =====================================================
INSERT INTO public.sims_users (email, password_hash, password_plain, role)
VALUES
    ('adhammorsy2311@gmail.com', encode(digest('admin123', 'sha256'), 'hex'), 'admin123', 'master_admin'),
    ('adham.ahmed@hanwhaegypt.com', encode(digest('admin123', 'sha256'), 'hex'), 'admin123', 'admin'),
    ('mohamed_aref@hanwhaegypt.com', encode(digest('bigboss1977', 'sha256'), 'hex'), 'bigboss1977', 'admin'),
    ('test@gmail.com', encode(digest('1234', 'sha256'), 'hex'), '1234', 'viewer'),
    ('extziahm@scangl.com', encode(digest('Ziad#99', 'sha256'), 'hex'), 'Ziad#99', 'admin'),
    ('anash@scangl.com', encode(digest('Anash#02', 'sha256'), 'hex'), 'Anash#02', 'admin'),
    ('Ayman@f200.com', encode(digest('Ayman#1234', 'sha256'), 'hex'), 'Ayman#1234', 'admin'),
    ('kdh2873@hanwhaegypt.com', encode(digest('hyungkim2026', 'sha256'), 'hex'), 'hyungkim2026', 'viewer')
ON CONFLICT (email)
DO UPDATE SET
